 ...
 * @author Scott Violet
 */
class GTKStyle extends SynthStyle implements com.sun.java.swing.plaf.gtk.GTKConstants {
    ...
    private static final com.sun.java.swing.plaf.gtk.GTKGraphicsUtils GTK_GRAPHICS = new com.sun.java.swing.plaf.gtk.GTKGraphicsUtils();
    ...
    GTKStyle(Font userFont, WidgetType widgetType) {
        ...
        if (pangoFontName != null) {
            pangoFont = com.sun.java.swing.plaf.gtk.PangoFonts.lookupFont(pangoFontName);
        }
        if (pangoFont != null) {
            this.font = pangoFont;
    ...
    public void installDefaults(SynthContext context) {
        ...
        if (!context.getRegion().isSubregion()) {
            context.getComponent().putClientProperty(
                ...
                com.sun.java.swing.plaf.gtk.GTKLookAndFeel.aaTextInfo);
        }
    }
    ...
    public SynthPainter getPainter(SynthContext state) {
        return com.sun.java.swing.plaf.gtk.GTKPainter.INSTANCE;
    }

    protected Color getColorForState(SynthContext context, ColorType type) {
        if (type == ColorType.FOCUS || type == com.sun.java.swing.plaf.gtk.GTKColorType.BLACK) {
            return BLACK_COLOR;
        }
        else if (type == com.sun.java.swing.plaf.gtk.GTKColorType.WHITE) {
            return WHITE_COLOR;
        }

        Region id = context.getRegion();
        int state = context.getComponentState();
        state = com.sun.java.swing.plaf.gtk.GTKLookAndFeel.synthStateToGTKState(id, state);
    ...
    private Color getStyleSpecificColor(SynthContext context, int state,
                                        ColorType type)
    {
        state = com.sun.java.swing.plaf.gtk.GTKLookAndFeel.synthStateToGTKStateType(state).ordinal();
        synchronized (sun.awt.UNIXToolkit.GTK_LOCK) {
    ...
    public Insets getInsets(SynthContext state, Insets insets) {
        ...
        if (id == Region.ARROW_BUTTON || id == Region.BUTTON ||
            ...
            insets = com.sun.java.swing.plaf.gtk.Metacity.INSTANCE.getBorderInsets(state, insets);
        }
        ...
        } else if (id == com.sun.java.swing.plaf.gtk.GTKEngine.CustomRegion.TITLED_BORDER) {
            return getThicknessInsets(state, insets);
        }
        return insets;
    }
    ...
    public boolean isOpaque(SynthContext context) {
        ...
        if (!com.sun.java.swing.plaf.gtk.GTKLookAndFeel.is3()) {
    ...
    public Object get(SynthContext context, Object key) {
        ...
        if (key == "ScrollPane.viewportBorderInsets") {
            ...
            if (name != null && name.startsWith("Spinner")) {
                ...
                int arrowSize = (pangoFontName != null) ?
                    com.sun.java.swing.plaf.gtk.PangoFonts.getFontSize(pangoFontName) : 10;
        ...
        } else if (com.sun.java.swing.plaf.gtk.GTKLookAndFeel.is3() && "ComboBox.forceOpaque".equals(key)) {
            return true;
